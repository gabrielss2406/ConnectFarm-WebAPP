    ...
    <nav className="fixed w-full p-2 z-20">
        ...
        <Sheet>
          ...
          <SheetContent side={"left"}>
            ...
            <div className="grid gap-4 py-4 justify-center mt-4">
              ...
              <Link href="/" className="mt-2 text-center cursor-not-allowed text-gray-400">Acessar Painel</Link>
      ...
      <div className="container mx-auto hidden lg:flex lg:justify-end justify-around items-center">
        ...
        `}>
          ...
          <Link href="/" className="cursor-not-allowed text-gray-400 hover:text-gray-300 mt-2">Acessar Painel</Link>
